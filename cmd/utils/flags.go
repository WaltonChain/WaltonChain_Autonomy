...
var (
	...
	AuxMiningEnabledFlag = cli.BoolFlag{
		Name:  "auxMine",
		Usage: "Enable aux mining",
	}
...
func setEthash(ctx *cli.Context, cfg *ethconfig.Config) {
	...
	if ctx.GlobalIsSet(AuxMiningEnabledFlag.Name) {
		cfg.Ethash.AuxMiningEnabled = ctx.GlobalBool(AuxMiningEnabledFlag.Name)
	}
}
