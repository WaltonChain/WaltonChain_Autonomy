...
import (
	...
	"go-wtc-aux/accounts/abi/bind"
	"go-wtc-aux/accounts/abi/bind/backends"
	"go-wtc-aux/common"
	"go-wtc-aux/common/mclock"
	"go-wtc-aux/consensus"
	"go-wtc-aux/consensus/ethash"
	"go-wtc-aux/contracts/checkpointoracle/contract"
	"go-wtc-aux/core"
	"go-wtc-aux/core/forkid"
	...
	"go-wtc-aux/ethdb"
	"go-wtc-aux/event"
	"go-wtc-aux/les/checkpointoracle"
	"go-wtc-aux/les/flowcontrol"
	vfs "go-wtc-aux/les/vflux/server"
	"go-wtc-aux/light"
	"go-wtc-aux/p2p"
