...
import (
	"go-wtc-aux/crypto/hash"

	"go-wtc-aux/crypto/x11/blake"
	"go-wtc-aux/crypto/x11/bmw"
	"go-wtc-aux/crypto/x11/cubed"
	"go-wtc-aux/crypto/x11/echo"
	"go-wtc-aux/crypto/x11/groest"
	"go-wtc-aux/crypto/x11/jhash"
	"go-wtc-aux/crypto/x11/keccak"
	"go-wtc-aux/crypto/x11/luffa"
	"go-wtc-aux/crypto/x11/shavite"
	"go-wtc-aux/crypto/x11/simd"
	"go-wtc-aux/crypto/x11/skein"
)
