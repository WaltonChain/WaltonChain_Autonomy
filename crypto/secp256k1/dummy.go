...
import (
	_ "go-wtc-aux/crypto/secp256k1/libsecp256k1/include"
	_ "go-wtc-aux/crypto/secp256k1/libsecp256k1/src"
	_ "go-wtc-aux/crypto/secp256k1/libsecp256k1/src/modules/recovery"
)
