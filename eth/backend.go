...
import (
	...
	"go-wtc-aux/core"
	"go-wtc-aux/core/bloombits"
	"go-wtc-aux/core/rawdb"
	"go-wtc-aux/core/state/pruner"
	"go-wtc-aux/core/types"
	"go-wtc-aux/core/vm"
	"go-wtc-aux/eth/downloader"
	"go-wtc-aux/eth/ethconfig"
	"go-wtc-aux/eth/filters"
	"go-wtc-aux/eth/gasprice"
	"go-wtc-aux/eth/protocols/eth"
	"go-wtc-aux/eth/protocols/snap"
	"go-wtc-aux/ethdb"
	"go-wtc-aux/event"
	"go-wtc-aux/internal/ethapi"
	"go-wtc-aux/internal/shutdowncheck"
	"go-wtc-aux/log"
	"go-wtc-aux/miner"
	"go-wtc-aux/node"
	"go-wtc-aux/p2p"
	"go-wtc-aux/p2p/dnsdisc"
