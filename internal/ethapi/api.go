...
func RPCMarshalHeader(head *types.Header) map[string]interface{} {
	result := map[string]interface{}{
		...
		"auxParentHash":       head.AuxParentHash,
		"auxSha3Uncles":       head.AuxUncleHash,
		"auxMiner":            head.AuxCoinbase,
		"auxStateRoot":        head.AuxRoot,
		"auxTransactionsRoot": head.AuxTxHash,
		"auxReceiptsRoot":     head.AuxReceiptHash,
		"auxLogsBloom":        head.AuxBloom,
		"auxCoinage":          (*hexutil.Big)(head.AuxCoinAge),
		"auxDifficulty":       (*hexutil.Big)(head.AuxDifficulty),
		"auxNumber":           (*hexutil.Big)(head.AuxNumber),
		"auxGasLimit":         (*hexutil.Big)(head.AuxGasLimit),
		"auxGasUsed":          (*hexutil.Big)(head.AuxGasUsed),
		"auxTimestamp":        (*hexutil.Big)(head.AuxTime),
		"auxExtraData":        hexutil.Bytes(head.AuxExtra),
		"auxMixHash":          head.AuxMixDigest,
		"auxNonce":            head.AuxNonce,
		"auxTxnumber":         hexutil.Uint64(head.AuxTxNumber),
	}
